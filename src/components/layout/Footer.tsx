...
function Footer() {
  return (
    <footer className="w-full py-8 md:py-16">
      {/* Kotak Utama Footer */}
      <div className="flex flex-col rounded-[2.5rem] border border-gray-200 bg-white dark:border-neutral-800 dark:bg-neutral-950 transition-colors duration-300 p-8 md:p-12 lg:p-16 gap-12 md:gap-20 mx-4 md:mx-0">
        
        {/* --- Bagian Atas --- */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          
          {/* Kiri Atas: Headline */}
          <h2 className="text-3xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white max-w-xl leading-tight">
          ...
          <div className="flex flex-wrap items-center gap-6 md:gap-8">
            {navItems.map((item, index) => (
              <a 
                key={index}
                href={item.href}
                className="text-gray-700 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-white transition-colors font-medium"
