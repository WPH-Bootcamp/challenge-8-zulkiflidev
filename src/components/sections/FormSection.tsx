          ...
          <form className="w-full flex flex-col gap-6 text-left">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 dark:border-neutral-700 bg-white
                           dark:bg-neutral-900 text-gray-900 dark:text-neutral-25 
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea 
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 dark:border-neutral-700 bg-white 
                           dark:bg-neutral-900 text-gray-900 dark:text-neutral-25 focus:outline-none focus:ring-2 
                           focus:ring-primary-200 transition-colors resize-none"
              ></textarea>
            </div>
              ...
              <label className="text-gray-900 dark:text-neutral-25 font-medium">Services</label>
                ...
                <div className="flex flex-row gap-3">
                    <div className="flex flex-col gap-3">
                          ...
                          <input type="checkbox" 
                                 className="w-5 h-5 rounded border-gray-300 dark:border-neutral-700 bg-white 
                                            dark:bg-neutral-900 accent-primary-200 cursor-pointer" />
                          ...
                          <label className="flex items-center gap-3 cursor-pointer">
                          <input type="checkbox" 
                                 className="w-5 h-5 rounded border-gray-300 dark:border-neutral-700 
                                            bg-white dark:bg-neutral-900 accent-primary-200 cursor-pointer" />
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <input type="checkbox" 
                               ...
                               dark:border-neutral-700 bg-white dark:bg-neutral-900 
                               accent-primary-200 cursor-pointer" />
