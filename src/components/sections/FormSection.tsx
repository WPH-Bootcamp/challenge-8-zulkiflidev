    ...
    <div id="contact" className="px-4 py-8 md:px-12 md:py-16 overflow-x-hidden">
              ...
              <label className="text-gray-900 dark:text-neutral-25 font-medium">Services</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   onChange={() => toggleService('Web Development')}
                                   className="w-5 h-5 rounded border-gray-300 accent-primary-200 
                                              cursor-pointer" />
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" 
                                   checked={selectedServices.includes('Mobile App Development')}
                                   onChange={() => toggleService('Mobile App Development')}
                                   className="w-5 h-5 rounded border-gray-300 accent-primary-200 
                                             cursor-pointer" />
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   onChange={() => toggleService('UI/UX Design')}
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" 
                                   checked={selectedServices.includes('Cloud Solutions')}
                                   onChange={() => toggleService('Cloud Solutions')}
                                   className="w-5 h-5 rounded border-gray-300 accent-primary-200 
                                                cursor-pointer" />
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" 
                                   checked={selectedServices.includes('Software Development')}
                                   onChange={() => toggleService('Software Development')}
                                   className="w-5 h-5 rounded border-gray-300 accent-primary-200
                                              cursor-pointer" />
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl p-8 max-w-sm w-full flex flex-col items-center 
                            text-center shadow-xl">
                <img src={isError ? messageInboxFailed : messageInbox} alt="Inbox" className="w-24 h-24 mb-4" />
